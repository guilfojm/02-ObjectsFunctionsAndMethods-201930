...
def main():
    ...
    #even_better_draw_circles(rg.Point(100, 50), 5, 7, 'red', 3)
    #even_better_draw_circles(rg.Point(-200, 0), 10, 15, 'green', 4)

    even_better_draw_circles(rg.Point(85, 50), 5, 5, 'red', 2)
    even_better_draw_circles(rg.Point(15, 50), 5, 5, 'red', 2)
    even_better_draw_circles(rg.Point(50, -30), 5, 10, 'green', 3)
    even_better_draw_circles(rg.Point(-75, 100), 5, 10, 'midnight blue', 3)
    even_better_draw_circles(rg.Point(-115, 175), 5, 5, 'red', 2)
    even_better_draw_circles(rg.Point(-45, 175), 5, 5, 'red', 2)
    even_better_draw_circles(rg.Point(150, 100), 5, 10, 'orange', 3)
    even_better_draw_circles(rg.Point(185, 185), 5, 5, 'red', 2)
    even_better_draw_circles(rg.Point(115, 185), 5, 5, 'red', 2)
    window.update()
